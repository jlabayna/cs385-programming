...
run_test_args "" "1 2 3 x" "Enter sequence of integers, each followed by a space: Error: Non-integer value 'x' received at index 3."
...
run_test_args "slow" "$(echo {5..1})" "Enter sequence of integers, each followed by a space: Number of inversions: 10"
run_test_args "slow" "2 1 3 4 5 6 7 8 9 10" "Enter sequence of integers, each followed by a space: Number of inversions: 1"
run_test_args "slow" "1 2 3 4 5 6 7 8 10 9" "Enter sequence of integers, each followed by a space: Number of inversions: 1"
run_test_args "slow" "3 1 2 5 4" "Enter sequence of integers, each followed by a space: Number of inversions: 3"
run_test_args "slow" "-40 -22 -24 -33 -60 -3 -1" "Enter sequence of integers, each followed by a space: Number of inversions: 6"
run_test_args "slow" "648 890 -279 -580 -158 706 -880 787 299 -438" "Enter sequence of integers, each followed by a space: Number of inversions: 26"
...
run_test_args "" "$(echo {5..1})" "Enter sequence of integers, each followed by a space: Number of inversions: 10"
run_test_args "" "2 1 3 4 5 6 7 8 9 10" "Enter sequence of integers, each followed by a space: Number of inversions: 1"
run_test_args "" "1 2 3 4 5 6 7 8 10 9" "Enter sequence of integers, each followed by a space: Number of inversions: 1"
run_test_args "" "3 1 2 5 4" "Enter sequence of integers, each followed by a space: Number of inversions: 3"
run_test_args "" "-40 -22 -24 -33 -60 -3 -1" "Enter sequence of integers, each followed by a space: Number of inversions: 6"
run_test_args "" "648 890 -279 -580 -158 706 -880 787 299 -438" "Enter sequence of integers, each followed by a space: Number of inversions: 26"
